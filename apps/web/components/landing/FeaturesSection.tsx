  ...
  return (
    ...
    >
      <div className="mb-16 text-center md:text-left">
        ...
        >
          Built from the ground up to integrate seamlessly into modern developer
          workflows.
        </motion.p>
      </div>
      ...
      >
        {features.map((feature, index) => (
          ...
          >
            <div className="absolute inset-0 bg-linear-to-br from-lynx-primary/0 to-lynx-accent/0 group-hover:from-lynx-primary/10 group-hover:to-lynx-accent/5 rounded-2xl transition-all duration-500 pointer-events-none" />
