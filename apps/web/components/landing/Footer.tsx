...
export const Footer = () => {
  return (
    <footer className="relative border-t border-white/10 bg-black pt-20 pb-10 overflow-hidden">
      <div className="absolute top-0 inset-x-0 h-px bg-linear-to-r from-transparent via-lynx-primary/50 to-transparent" />
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[80%] h-75 bg-lynx-primary/10 blur-[150px] mix-blend-screen rounded-full pointer-events-none" />

      <div className="absolute -bottom-20 -right-20 text-[300px] text-white/2 pointer-events-none select-none z-0 rotate-12">
        <TerminalSquare className="w-100 h-100" strokeWidth={1} />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
              ...
              {["Features", "Integrations", "Pricing", "Changelog"].map(
                (item) => (
                  <li key={item}>
                    <a
                      href="#"
                      className="text-sm text-zinc-400 hover:text-white hover:pl-1 transition-all"
                    >
                      {item}
                    </a>
                  </li>
        ...
        >
          ...
          <div className="flex gap-4">
            <a
              href="#"
              className="text-zinc-500 hover:text-white transition-colors hover:-translate-y-1"
            >
